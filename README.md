...
- 支持标签管理和搜索
- 全局默认预设（快捷键和右键菜单使用）
- **自动填充**：配置URL规则后，页面加载时自动填充（仅首次加载/刷新时触发）
...
- Edge 扩展: [Edge 点击进入](https://microsoftedge.microsoft.com/addons/detail/%E5%AD%97%E6%AE%B5%E5%A1%AB%E5%85%85/aekjpmdkkenfoclhkmmjjchnebfaopej?hl=zh-CN)
